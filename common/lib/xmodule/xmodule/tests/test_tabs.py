"""
Test cases for xBlock tab fields
"""
...
class TabTestCase(TestCase):
    ...
    def check_tab(
        ...
        'expected_can_display_value' is the expected value to be returned by the
            tab's can_display method with True values for its is_user_authenticated
            and is_user_staff parameters.
        """
        # create tab
